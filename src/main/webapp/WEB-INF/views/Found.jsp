...
<head>
    ...
    <title>Found Items - HomeAgain</title>
...
<body>
    ...
    <header>
        ...
        <nav>
            ...
            <a href="<%=request.getContextPath()%>/found" class="active">Found</a>
    ...
    <main class="container">
        <div class="page-header">
            <h1>Found Items</h1>
            <a href="<%=request.getContextPath()%>/report-found" class="report-button">+ Report Found Item</a>
        </div>
        
        <div class="filters">
            <form id="searchForm" action="<%=request.getContextPath()%>/found" method="get" class="search-form">
                <input type="text" name="search" class="search-input" placeholder="Search found items..." value="${param.search}">
        ...
        <div class="items-grid">
            ...
            <c:forEach items="${foundItems}" var="item">
                <div class="item-card" onclick="showItemDetails('${item.id}', '${item.title}', '${item.description}', '${item.location}', '${item.postedAt}', '${item.imageUrl}')">
                    ...
                    <div class="item-content">
                        ...
                        <div class="item-meta">Found at ${item.location}</div>
            ...
            <c:if test="${empty foundItems}">
                <div style="grid-column: 1/-1; text-align: center; padding: 2rem;">
                    <p style="color: var(--text-light); font-size: 1.1rem;">No approved found items at the moment.</p>
                </div>
            </c:if>
        </div>
    </main>
    ...
    <script>
        ...
        document.getElementById('searchForm').addEventListener('submit', function(e) {
            ...
            if (!searchInput.value.trim()) {
                e.preventDefault();
                window.location.href = '<%=request.getContextPath()%>/found';
            }
        });
    </script>
</body>
